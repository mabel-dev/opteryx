...
STATEMENTS = [
        ...
        ("SELECT * FROM $statistics", 10, 2, None),
...
#        ("SELECT * FROM $planets AS P1 UNION SELECT * FROM $planets AS P2;", 9, 20, UnsupportedSyntaxError),
        ...
        ("SELECT * FROM $planets AS P RIGHT ANTI JOIN $satellites AS S USING(id);", 168, 8, None),
        ("SELECT * FROM $planets AS P LEFT SEMI JOIN $satellites AS S USING(id);", 9, 20, None),
        ("SELECT * FROM $planets AS P RIGHT SEMI JOIN $satellites AS S USING(id);", 9, 8, None),
