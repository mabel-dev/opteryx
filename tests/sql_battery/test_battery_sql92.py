...
#    ("SELECT CASE 0 WHEN 2 , 2 THEN 1 ELSE 1 END", "F261-01"),
#    ("SELECT CASE 0 WHEN 2 , 2 THEN 1 ELSE NULL END", "F261-01"),
#    ("SELECT CASE 0 WHEN 2 , 2 THEN 1 END", "F261-01"),
#    ("SELECT CASE 0 WHEN 2 , 2 THEN NULL ELSE 1 END", "F261-01"),
#    ("SELECT CASE 0 WHEN 2 , 2 THEN NULL ELSE NULL END", "F261-01"),
#    ("SELECT CASE 0 WHEN 2 , 2 THEN NULL END", "F261-01"),
