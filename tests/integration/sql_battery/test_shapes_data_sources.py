...
STATEMENTS = [
        ...
        ("SELECT * FROM iceberg.opteryx.planets WHERE `name` = 'Earth'", 1, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE name = 'Mars'", 1, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE name <> 'Venus'", 8, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE name = '********'", 0, 20, None),
        ("SELECT id FROM iceberg.opteryx.planets WHERE diameter > 10000", 6, 1, None),
        ("SELECT name, mass FROM iceberg.opteryx.planets WHERE gravity > 5", 6, 2, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE numberOfMoons >= 5", 5, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE mass < 10 AND diameter > 1000", 5, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets ORDER BY distanceFromSun DESC", 9, 20, None),
        ("SELECT name FROM iceberg.opteryx.planets WHERE escapeVelocity < 10", 3, 1, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE obliquityToOrbit > 25", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE meanTemperature < 0", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE surfacePressure IS NULL", 4, 20, None),
        ("SELECT name FROM iceberg.opteryx.planets WHERE orbitalEccentricity < 0.1", 7, 1, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE orbitalPeriod BETWEEN 100 AND 1000", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) = 5", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) <> 5", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) == 5", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) != 5", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) = 5", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE NOT LENGTH(name) = 5", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE NOT LENGTH(name) == 5", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets LIMIT 5", 5, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE numberOfMoons = 0", 2, 20, None),
        ("SELECT id FROM iceberg.opteryx.planets WHERE density > 4000 ORDER BY id ASC", 3, 1, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE gravity > 10 OR meanTemperature > 100", 4, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE orbitalInclination <= 5", 7, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE perihelion >= 150", 6, 20, None),
        ("SELECT name FROM iceberg.opteryx.planets WHERE aphelion < 1000", 5, 1, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) >= 7", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE id IN (1, 3, 5)", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE id NOT IN (1, 3, 5)", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE rotationPeriod < 0", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE mass > 100 AND mass < 1000", 2, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE name LIKE 'M%'", 2, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE orbitalVelocity > 20", 4, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE escapeVelocity BETWEEN 10 AND 20", 2, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) <= 6", 6, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets ORDER BY id DESC LIMIT 3", 3, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE gravity IS NOT NULL", 9, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE surfacePressure IS NOT NULL", 5, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE meanTemperature <= 100", 7, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE numberOfMoons > 10", 4, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE LENGTH(name) > 7", 0, 20, None),
        ("SELECT * FROM iceberg.opteryx.planets WHERE distanceFromSun BETWEEN 100 AND 1000", 4, 20, None),
