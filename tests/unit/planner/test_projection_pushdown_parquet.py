...
STATEMENTS = [
    ...
    ("SELECT Company FROM (SELECT Company, Mission, LENGTH(Location) AS LL FROM testdata.missions) AS launches;", 1),
    ("SELECT Mission FROM (SELECT Company, Mission, LENGTH(Location) AS LL FROM testdata.missions) AS launches;", 1),
    ("SELECT LL FROM (SELECT Company, Mission, LENGTH(Location) AS LL FROM testdata.missions) AS launches;", 1),
    ("SELECT * FROM (SELECT Company, Mission, LENGTH(Location) AS LL FROM testdata.missions) AS launches;", 3),
