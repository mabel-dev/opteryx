...
class TestSIMDSearch:
    ...
    def test_search_basic(self):
        ...
        data = b"hello world"
        result = strings.find_char(data, ord('o'))
    ...
    def test_search_not_found(self):
        ...
        data = b"hello world"
        result = strings.find_char(data, ord('x'))
    ...
    def test_search_at_start(self):
        ...
        data = b"hello world"
        result = strings.find_char(data, ord('h'))
        assert result == 0
    ...
    def test_search_at_end(self):
        ...
        data = b"hello world"
        result = strings.find_char(data, ord('d'))
        assert result == 10
    ...
    def test_search_repeated_chars(self):
    ...
    def test_count_basic(self):
        ...
        data = b"hello world"
        result = strings.count_char(data, ord('l'))
    ...
    def test_count_none(self):
        ...
        data = b"hello world"
        result = strings.count_char(data, ord('x'))
        assert result == 0
    ...
    def test_count_all(self):
        ...
        data = b"aaaa"
        result = strings.count_char(data, ord('a'))
        assert result == 4

    def test_count_long_string(self):
    ...
    def test_find_all_basic(self):
        ...
        data = b"hello world"
        result = strings.find_all_char(data, ord('l'))
    ...
    def test_find_all_none(self):
        ...
        data = b"hello world"
        result = strings.find_all_char(data, ord('x'))
        assert result == []
    ...
    def test_find_all_single(self):
        ...
        data = b"hello world"
        result = strings.find_all_char(data, ord('h'))
        assert result == [0]

    def test_find_all_long_string(self):
    ...
    def test_search_newline(self):
        ...
        data = b"line1\nline2\nline3"
        result = strings.find_char(data, ord('\n'))
    ...
    def test_count_newlines(self):
        ...
        data = b"line1\nline2\nline3\n"
        result = strings.count_char(data, ord('\n'))
        assert result == 3

    def test_find_all_newlines(self):
        ...
        data = b"line1\nline2\nline3"
        result = strings.find_all_char(data, ord('\n'))
        assert result == [5, 11]
    ...
    def test_search_empty_string(self):
        ...
        data = b""
        result = strings.find_char(data, ord('a'))
        assert result == -1
    ...
    def test_find_all_empty_string(self):
        ...
        data = b""
        result = strings.find_all_char(data, ord('a'))
        assert result == []
    ...
    def test_search_with_null_byte(self):
        ...
        result = strings.find_char(data, 0)
        assert result == 5
    ...
    def test_search_high_byte_value(self):
        ...
        result = strings.find_char(data, 0xFF)
        assert result == 3
