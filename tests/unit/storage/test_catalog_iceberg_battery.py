...
from opteryx.exceptions import DatasetReadError, DatasetNotFoundError
...
STATEMENTS = [
    ...
    ("SELECT name FROM iceberg.opteryx.planets FOR '1846-11-13 00:00:00' WHERE name = 'Uranus'", 1, 1, None),
    ("SELECT name FROM iceberg.opteryx.planets FOR '1930-03-12 00:00:00' WHERE name = 'Pluto'", 0, 1, None),
    ("SELECT name FROM iceberg.opteryx.planets FOR '2025-11-18 21:06:21.210000' WHERE name = 'Pluto'", 1, 1, None),
    ...
    ("SELECT name FROM iceberg.opteryx.planets WHERE name LIKE '%e%';", 4, 1, None),  # Mercury, Venus, Jupiter, Neptune
    ("SELECT name FROM iceberg.opteryx.planets WHERE name NOT LIKE '%e%';", 5, 1, None),  # Earth, Mars, Saturn, Uranus, Pluto
