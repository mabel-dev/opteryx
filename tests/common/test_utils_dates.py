...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("1999-12-31 23:59:59.9999", datetime.datetime(1999,12,31,23,59,59,9999)),
        ("1999-12-31T23:59:59.9999", datetime.datetime(1999,12,31,23,59,59,9999)),
        ("1999-12-31T23:59:59.9999Z", datetime.datetime(1999,12,31,23,59,59,9999))
    ],
    # fmt:on
)
def test_date_parser(string, expect):

    assert dates.parse_iso(string) == expect
