...
if SHOULD_BUILD_EXTENSIONS:
    ...
    extensions = [
        ...
        Extension(
            ...
            sources=["opteryx/compiled/functions/strings.pyx", "src/cpp/simd_search.cpp", "src/cpp/simd_string_ops.cpp"],
...
""")
    ...
    extensions.append(
        Extension(
            ...
            sources=[list_ops_file, "src/cpp/simd_search.cpp", "src/cpp/simd_string_ops.cpp"] + re2_sources,
            language="c++",
            include_dirs=include_dirs
            + [
                "third_party/abseil",
