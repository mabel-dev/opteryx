...
def left_join_optimized(
    ...
    - Streams through right relation in chunks
    - Uses efficient bit array for tracking matched left rows
    ...
    Parameters:
        ...
        left_hash: Pre-built hash map of the left relation
