...
We try to push the limit to the other side of PROJECTS. This includes pushing
LIMIT and HEAPSORT (combined ORDER BY + LIMIT) nodes before projections when
the ordering columns are not created by the projection.
"""
